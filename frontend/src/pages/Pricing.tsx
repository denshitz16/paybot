...
const PLANS: Plan[] = [
  {
    name: 'Starter Node',
    price: 'Free',
    desc: 'Deploy a basic settlement node. Ideal for low-volume testing and platform exploration.',
    borderCls: 'border-white/[0.08]',
    bgCls: 'bg-white/[0.02]',
    glowCls: 'bg-blue-700/5',
    ctaLabel: 'Initialize Node',
    ctaTo: '/register',
    ctaCls: 'bg-white/[0.06] hover:bg-white/[0.12] border border-white/[0.12] text-slate-200 hover:text-white',
    features: [
      'Telegram Terminal access',
      'GCash & Maya e-wallet',
      'Dynamic QRPH generation',
      'Real-time transaction alerts',
      'Standard ledger history',
      'Technical support via email',
    ],
    notIncluded: [
      'Industrial Card Processing',
      'Ultra T+0 USDT settlement',
      'Virtual accounts (InstaPay)',
      'Global clearing channels',
      'Advanced grid analytics',
    ],
  },
  {
    name: 'Verified Merchant',
    price: 'Per-txn pricing',
    desc: 'For high-performance merchants requiring industrial-scale local and global clearing.',
    ...
    features: [
      ...
      'Opening Liquidity: 600 USDT',
      'Industrial Card Acceptance (Visa/MC)',
      'Alipay Global collection',
      'WeChat Pay Global collection',
      'Direct BSP InstaPay clearing',
      'Ultra T+0 same-day settlement',
      'Advanced node telemetry',
      'Priority industrial support',
    ],
  },
  {
    name: 'Enterprise Grid',
    price: 'Custom SLA',
    desc: 'For financial institutions and large-scale commercial grids with custom compliance requirements.',
    badge: 'Managed Cluster',
    ...
    ctaLabel: 'Consult Infrastructure',
    ctaTo: SUPPORT_URL,
    ctaCls: 'bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg shadow-emerald-600/20',
    features: [
      'Everything in Verified',
      'Dedicated compliance manager',
      'Custom settlement protocols',
      'Multi-branch cluster hierarchy',
      'Direct API/SDK bridge access',
      'White-label grid deployment',
